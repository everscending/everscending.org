...
import seedOfLifeIcon from "../assets/seed-of-life-dark.svg";
import "./Resume.css";
        ...
        <Layout id="resume">
            <div className="page-container">
                <div className="header-icon">
                    <img src={seedOfLifeIcon} width="75" alt="seed of life" />
                </div>
                ...
                <p className="technical-skills">
                    Agentic Coding, Typescript, React, Node.js, Python,
            ...
            <div className="page-container">
                ...
                <ul>
                    <li>
                        Architected and implemented a multi-site, multi-lingual
                        e-commerce platform that doubled annual revenue from
                        $12M to $24M, solving complex challenges around
                        inventory management, localization, and payment
                        processing
                    </li>
                    <li>
                        Integrated NETbilling, USAePay, and PayPal gateways to
                        expand payment options
                    </li>
                    <li>
                        Developed UI for translating product catalog to German,
                        Hebrew, and Spanish
                    </li>
                    <li>
                        Supported issues with merchant bank and payment gateways
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        Spearheaded development of the Journalism Online Tool at
                        the University of Texas, creating a flexible content
                        management system that empowered multiple departments to
                        manage web-based publications independently
                    </li>
                    <li>
                    ...
                    <li>
                        Created SDK for integrating UT's EID auth system into
                    ...
                    <li>
                        Trained students, faculty, and staff on use of hardware
